...
import { teamData, swiperSettings } from "@/utils";
      ...
      <Swiper {...swiperSettings} speed={600} className="t-swiper">
        ...
        {teamData.map((data, i) => (
          <SwiperSlide key={`ss-${i}`}>
            <div className="team__content" style={{height: inView ? "500px" :  0, overflow: "hidden", transition: "height 0.7s cubic-bezier(0.76, 0, 0.24, 1)", transitionDelay: `${0.2*i}s`}}>
