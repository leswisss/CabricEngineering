      ...
      <div className={styles.project__data}>
        <div className={`container ${styles.pd__container}`}>
          <div className={styles.pd__foot}>
            <span className={`${styles.pd__span} ${styles.span1}`}>
              {currentLng === "en"
                ? project.location.locationen
                : project.location.locationfr}
            </span>
            <p className={styles.p__name}>{project.name}</p>
            <span className={`${styles.pd__span} ${styles.span2}`}>
              {currentLng === "en"
                ? project.projecttype.typeen
                : project.projecttype.typefr}
            </span>
          </div>
        </div>
      </div>
