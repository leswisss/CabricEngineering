...
const ProjectMid = ({ project }: { project: IProject }) => {
  ...
  export const parseFloors = (value?: string): number | string | undefined => {
          ...
          <div className={`${styles.right} ${styles.pmt__right}`}>
            ...
            {project.floors && (
              <div className={styles.pmt__wrap}>
                ...
                <div className={styles.pmt__left}>
                  {
                    isNaN(Number(project.floors))
                      ? project.floors // renders "Ground Floor" as-is
                      : `${Number(project.floors)}` // renders "3 Floors"
                  }
                </div>
              </div>
            )}
