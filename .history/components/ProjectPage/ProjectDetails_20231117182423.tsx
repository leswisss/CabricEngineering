...
const ProjectDetails = () => {
  ...
  const detailData = [
    {
      data: "The Urban Oasis spans an area of 400 square meters and
      "comprises residential apartments, office spaces, retail outlets and parking spots. The residential apartments offer a
