  ...
  return (
    <section className="project__details">
      <div className="container pro-d__container">
        <div className="prod__container ninety">
          <div className="prod__top">
            ...
            <div className="prodt__right">
              <div className="prodt__overflow">
                <p>The Urban Oasis spans an area of 400 square meters and comprises residential apartments, office spaces, retail outlets and parking spots.</p>
              </div>
              <div className="prodt__overflow"></div>
            </div>
          </div>
