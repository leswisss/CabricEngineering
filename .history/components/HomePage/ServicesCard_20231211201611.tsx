...
const ServicesCard = ({ data, i }: { data: serviceCardProps, i:number }) => {
  ...
  return (
    <div className="services__card-wrapper" ref={ref}>
      <div className="services__card-cover" style={{height: inView ? "100%" : "0%", transitionDelay: windowWidth > 1000 ? `${i*0.4}s` : "0s"}}>
        <div
        ...
        >
          ...
          <div className="service__content" style={{ color: activeBack ? "#FBF0E2" : "#035336" }}>
            ...
            <div className="con-bottom" onClick={() => setActiveModal(true)}>
              <span className="arrow-span"  style={{ border: activeBack ? "border: 1px solid var(--green)" : "border: 1px solid var(--green);" }}>
