...
const PortfolioContent = () => {
  ...
  return (
    <div className="portfolio__content" ref={ref} style={{opacity: inView ? 1 : 0}}>
      ...
      <div className="pc-bottom">
        ...
        <div className="pcb__right">
          {portfolioContentData.map((data, i) => (
            ...
            >
              <span style={{ opacity: activeSlide === i ? 0.5 : 1 }}>{data.name}</span> <span style={{ opacity: activeSlide === i ? 0.5 : 1 }}>{data.year}</span>
            </div>
          ))}
        </div>
      </div>
