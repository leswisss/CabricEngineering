...
import { preSvgAnim, preTextAnim } from "@/animations";
      ...
      <div className="preloader__text">
        <div className="home__active">
          <div className="preloader__overflow">
            <motion.div variants={preSvgAnim} initial="initial" animate="entry" className="svg__overflow">
              <svg
          ...
          <div className="preloader__overflow">
            <p>
              {array2.map((word, i) => (
                <motion.span custom={i} variants={preTextAnim} initial="initial" animate="entry" key={`w${i}`} className="array-2" onAnimationComplete={() => setOnComplete1(true)}>
                  {word}
                </motion.span>
              ))}
            </p>
        ...
        <div className="preloader-content">
          {preloaderData.map((data, i) => {
            ...
            return (
              <h2
                key={`pc-${i}`}
                style={{ display: onComplete1 ? "block" : "none" }}
              >
                {data.name}
              </h2>
            );
