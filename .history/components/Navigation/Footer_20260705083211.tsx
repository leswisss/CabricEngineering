    ...
    <footer className={styles.footer}>
      ...
      <div className={`container ${styles.foot__container}`}>
        ...
        <div className={styles.footer__bottom}>
          <span className="">©2026 CABRIC ENGINEERING.</span>
          <Link className={styles.fb__link} href={currentLng === "en" ? "/privacy" : "/fr/confidentialite"}>
            {t("privacy")}
          </Link>
          <div className={styles.webby}>
            <span>{t("websiteby")}</span>
            <span onClick={() => setActiveBetter(!activeBetter)} className={styles.better}>
              BetterMarque SARL
            </span>
          </div>
        </div>
