      ...
      <div className="preloader__text">
        <div className="home__active">
          ...
          <div className="preloader__overflow">
            <p>
              {array2.map((word, i) => (
                <motion.span custom={i} variants={preTextAnim} initial="initial" animate={ !onComplete1 ? "entry" : "iexit"} key={`w${i}`} className="array-2" onAnimationComplete={() => setOnComplete1(true)}>
                  {word}
                </motion.span>
              ))}
            </p>
