  ...
  return (
    <div className={styles.an__section}>
      ...
      <div className={styles.vismiss}>
        {misvisContent.map((data, i) => (
          <div className={styles.miss} key={i}>
            <div className={`container ${styles.miss__container}`}>
              <h3 className={styles.miss__h3}>{data.name}</h3>
              <div className={styles.miss__right}>
                <p>{data.text}</p>
              </div>
            </div>
          </div>
