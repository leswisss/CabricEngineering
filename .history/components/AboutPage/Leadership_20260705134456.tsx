            ...
            <div className={styles.lead__wrap} key={i}>
              <div className={styles.image__wrap}>
                <Image
                  fill
                  quality={100}
                  alt={`${data.name} - CaBric Engineering`}
                  src={data.image}
                  placeholder="blur"
                />
              </div>
              <div className={styles.lead__mid}>
                <p className={styles.lm__p}>{data.name}</p>
                <span className={styles.lm__span}>{t("about:co")}</span>
              </div>
              <div className={styles.lead__bot}>
                <p className={styles.lb__p}>{data.text}</p>
                <Link
