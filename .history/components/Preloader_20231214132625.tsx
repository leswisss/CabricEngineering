...
const Preloader = () => {
  ...
  const shouldDisplay = path === "/notre-equipe/" ? pathname.includes(path) : pathname === path;
  ...
  return (
    <section className="preloader" style={{display: onComplete2 ? "none" : "block"}}>
        ...
        <div className="preloader-content">
          {
            preloaderData.map((data, i) => (
              <h2 key={`pc-${i}`} style={{display: pathname==="/services" ? "block" : "none"}}>{data.name}</h2>
            ))
          }
        </div>
