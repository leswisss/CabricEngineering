...
import PROJECT13 from "../public/images/project13.jpg"
import PROJECT14 from "../public/images/project14.jpg"
import PROJECT15 from "../public/images/project15.jpg"
import CEO from "../public/images/ceo2.jpg"
...
export const serviceCardData = [
  {
    ...
    title: "ARCHITECTURE",
    image: SERVICE,
    text: "Cabric Engineering is where innovation meets aesthetics in architectural design. We specialize in designing public and residential buildings that stand out for their visual appeal, sustainability, and user-friendliness. Our architects don't just draw plans; they create spaces that enhance lives. We collaborate with clients, stakeholders, and the community, ensuring our designs are efficient, accessible, and blend seamlessly with their surroundings."
  },

  {
    ...
    title: "INTERIOR",
    image: SERVICE2,
    text: "Imagine a home that mirrors your lifestyle and taste - that's what Cabric Engineering's residential interior design service offers. Our expert designers delve into your preferences, creating spaces that are a true reflection of you. We don't just design rooms; we curate experiences. From optimizing space utilization to selecting the perfect color palette and decor, we transform houses into warm, inviting homes."
  },

  {
    ...
    title: "CONSTRUCTION",
    image: SERVICE3,
    text: "Building your dream home is an exciting journey, and Cabric Engineering is your trusted partner in this endeavor. We offer end-to-end residential construction services, turning architectural blueprints into reality. Our team of seasoned professionals ensures top-notch construction quality, timely project completion, and strict adherence to safety norms. From single-family homes to multi-story apartments, we bring superior craftsmanship and meticulous attention to detail to every project, making your dream home a reality."
  }
] 
